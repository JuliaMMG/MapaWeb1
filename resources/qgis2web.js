...
var map = new ol.Map({
    ...
    layers: [new ol.layer.Tile({source:new ol.source.OSM}),lyr_Colombia_0,lyr_Departamentos_1,lyr_Municipios_2],
    view: new ol.View({
         maxZoom: 24, minZoom: 3
    })
});
...
map.getView().fit([-9688553.422773, -430847.615167, -6796537.563299, 1465551.395716], map.getSize());
map.getView().setCenter(ol.proj.fromLonLat([-75.5791257992955,6.2416841220324875])); //TRansformación coordenadas
map.getView().setZoom(5); //Ajustar Zoom
